 ...
 *******************************************************************************/
package com.qk.applibrary.widget.pullrefresh;
...
import com.qk.applibrary.widget.pullrefresh.internal.EmptyViewMethodAccessor;
import com.qk.applibrary.widget.pullrefresh.internal.IndicatorLayout;
...
public abstract class PullToRefreshAdapterViewBase<T extends AbsListView> extends PullToRefreshBase<T> implements
	...
	private void addIndicatorViews() {
		...
		if (mode.showHeaderLoadingLayout() && null == mIndicatorIvTop) {
			...
			params.rightMargin = getResources().getDimensionPixelSize(R.dimen.dimen_10_dip);
