...
public class AppUpdateDialog {
	 ...
	 */
	public AppUpdateDialog(Context context,String applicationId, final AppUpdateListener updateListener, String downloadUrl, boolean showCancelButton,String saveApkPath) {
